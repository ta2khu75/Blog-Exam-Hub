...
const QuizForm = ({ examResponse, refresh , quizResponse}: Props) => {
    ...
    useEffect(() => {
        ...
        // form.setFieldValue("exam_type", examResponse.id);
    }, [])
    ...
    return (
        ...
        >
            ...
            <Form.Item<QuizRequest> label="Exam Id" hidden name={"exam_id"} rules={[
                { required: true, message: "please input exam id" }
            ]}>
                <Input/>
            </Form.Item>
            <Form.Item<QuizRequest> label="Questiton" name={"question"} rules={[
                { required: true, message: "please input title" }
            ]} >
                <Input />
            </Form.Item>
            <Form.Item<QuizRequest> label="Quiz Type" name={"quiz_type"} rules={[
                { required: true, message: "please select quiz type" }
            ]} >
                <Select options={quizTypes.map((e) => ({ value: e, label: <span>{e}</span> }))} />
            </Form.Item>
