        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8 col-12 mx-auto">
              <h2 className="text-white text-center">Create and Take Exams Online</h2>
              <h6 className="text-center">ExamMaster allows you to easily create and take exams online, offering customizable settings, instant feedback, and secure access from any device.</h6>
