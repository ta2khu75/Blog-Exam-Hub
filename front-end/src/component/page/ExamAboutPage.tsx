                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 col-12 m-auto">
                            ...
                            <div className="row my-4">
                                <div className="col-lg-6 col-md-6 col-12">
                                    <img src="images/businesswoman-using-tablet-analysis.jpg" className="topics-detail-block-image img-fluid" alt="Businesswoman" />
                                </div>
                                <div className="col-lg-6 col-md-6 col-12 mt-4 mt-lg-0 mt-md-0">
                                    <img src="images/colleagues-working-cozy-office-medium-shot.jpg" className="topics-detail-block-image img-fluid" alt="Colleagues" />
                                </div>
                            </div>
