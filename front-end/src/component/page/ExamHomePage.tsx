                        ...
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                            {examCategories.map(examCategory =>
                                <li key={examCategory.id} className="nav-item" role="presentation">
                                    <button className="nav-link active" id="design-tab" data-bs-toggle="tab" data-bs-target="#design-tab-pane" type="button" role="tab" aria-controls="design-tab-pane" aria-selected="true">{examCategory.name}</button>
                                </li>
                            )}
